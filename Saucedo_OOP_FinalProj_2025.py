...
class DNA(Seq):
    ...
    def reverse_complement(self):
        ...
        result = ''
        for c in reversed(self.sequence):  # Iterate over the reversed sequence
            result = complements.get(c, 'N') + result
        return result   
...
class Protein(Seq):
    ...
    def total_hydro(self):
        hydro_score = 0
        for amino_acid in kyte_doolittle:
